...
public class HealthView : MonoBehaviour
{
    ...
    [SerializeField] private Base _hasHealth;
    ...
    private void Start()
    {
        ...
        _maxHealthNumber.text = _hasHealth.GetMaxHealth().ToString();
        _currentHealthNumber.text = _hasHealth.GetCurrentHealth().ToString();

        _hasHealth.AddListenerOnChangeHealthEvent(ChangeHealthBars);
    }
    ...
    {
        float currentHealthRealtion = (float)_hasHealth.GetCurrentHealth() / _hasHealth.GetMaxHealth();
